...
<div style='text-align:center'>
    <h1 style='color:#009999;'>Industrial Copper Modelling Application</h1>
</div>
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Shivashankar</h6>', unsafe_allow_html=True )  
